...
const Who = () => {
  return (
    <div className='grid grid-cols-2 h-auto  mt-20 gap-2 p-4 leading-10  gap-x-4 mx-2 font-patua'>
    ...
    <div className='text-black bg-yellow-400 text-lg col-start-2 col-end-3 p-4 rounded-xl place-self-center max-h-screen overflow-scroll' >
    <h1 className='text-center text-3xl'>Who is this guy?</h1>
    ...
    <br/>
    <h1 className='text-xl text-center'>Popular Claims</h1>
